<template>
  <div class="arlo_tm_mobile_menu">
    <div class="mobile_menu_inner">
      <div class="container">
        <div class="mobile_in">
          <div class="logo">
            <a href="#">
              <!-- The logo image source might need to be updated or handled locally -->
              <img src="https://marketifythemes.net/html/arlo/img/logo/mobile/dark.png" alt="mobile logo">
            </a>
          </div>
          <div class="my_trigger">
            <div @click="toggleMenu" class="hamburger hamburger--collapse-r" :class="{ 'is-active': mobileMenuOpen }">
    ...
    <div class="dropdown" v-show="mobileMenuOpen">
      <div class="container">
        <div class="dropdown_inner">
          <ul class="anchor_nav">
            <!-- These links are for in-page scrolling, matching the original. They can be updated to router-links if needed. -->
            <li><a href="#home" @click="closeMenu">Home</a></li>
            <li><a href="#about" @click="closeMenu">About</a></li>
            <li><router-link to="/resume" @click="closeMenu">Resume</router-link></li>
